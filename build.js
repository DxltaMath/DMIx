...
zipdir("./src/", { saveTo: "./build/extension.zip" }, function (err, _buffer) {
	...
	zipdir("./firefox/", { saveTo: "./build/extension.xpi" }, function (err, _buffer) {
		...
		console.warn("IMPORTANT: IF YOU ARE MAKING AN OFFICIAL DMIx RELEASE, THEN PLEASE REMEMBER TO SIGN THE .CRX WITH A PRIVATE KEY FILE.\n");
